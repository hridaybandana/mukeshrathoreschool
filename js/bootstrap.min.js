...
! function (t, e) {
  ...
  class pt extends q {
    ...
    show() {
      ...
      if (!B.trigger(this._element, "show.bs.dropdownboot", e).defaultPrevented) {
        if (this._inNavbar) V.setDataAttribute(this._menu, "popper", "none");
        else {
          if (void 0 === s) throw new TypeError("Bootstrap's dropdownboots require Popper (https://popper.js.org)");
          let e = this._element;
        ...
        "ontouchstart" in document.documentElement && !t.closest(".navbar-nav") && [].concat(...document.body.children).forEach(t => B.on(t, "mouseover", f)), this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.toggle("show"), this._element.classList.toggle("show"), B.trigger(this._element, "shown.bs.dropdownboot", e)
      }
    }
    hide() {
      if (g(this._element) || !this._menu.classList.contains("show")) return;
    ...
    _addEventListeners() {
      B.on(this._element, "click.bs.dropdownboot", t => {
        t.preventDefault(), this.toggle()
      })
    }
    _completeHide(t) {
      B.trigger(this._element, "hide.bs.dropdownboot", t).defaultPrevented || ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(t => B.off(t, "mouseover", f)), this._popper && this._popper.destroy(), this._menu.classList.remove("show"), this._element.classList.remove("show"), this._element.setAttribute("aria-expanded", "false"), V.removeDataAttribute(this._menu, "popper"), B.trigger(this._element, "hidden.bs.dropdownboot", t))
    }
    _getConfig(t) {
      if (t = {
          ...
          ...V.getDataAttributes(this._element),
          ...t
        }, d("dropdownboot", t, this.constructor.DefaultType), "object" == typeof t.reference && !c(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError("dropdownboot".toUpperCase() + ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.');
      return t
    }
    _getMenuElement() {
      return i.next(this._element, ".dropdownboot-menu")[0]
    }
    _getPlacement() {
    ...
    _selectMenuItem({
      ...
      const s = i.find(".dropdownboot-menu .dropdownboot-item:not(.disabled):not(:disabled)", this._menu).filter(u);
      s.length && A(s, e, "ArrowDown" === t, !s.includes(e)).focus()
    }
    static dropdownbootInterface(t, e) {
    ...
    static jQueryInterface(t) {
      return this.each((function () {
        pt.dropdownbootInterface(this, t)
      }))
    }
    static clearMenus(t) {
      if (t && (2 === t.button || "keyup" === t.type && "Tab" !== t.key)) return;
      const e = i.find('[data-bs-toggle="dropdownboot"]');
    ...
    static dataApiKeydownHandler(t) {
      if (/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || "Escape" !== t.key && ("ArrowDown" !== t.key && "ArrowUp" !== t.key || t.target.closest(".dropdownboot-menu")) : !ot.test(t.key)) return;
      const e = this.classList.contains("show");
      if (!e && "Escape" === t.key) return;
      if (t.preventDefault(), t.stopPropagation(), g(this)) return;
      const s = () => this.matches('[data-bs-toggle="dropdownboot"]') ? this : i.prev(this, '[data-bs-toggle="dropdownboot"]')[0];
  ...
  B.on(document, "keydown.bs.dropdownboot.data-api", '[data-bs-toggle="dropdownboot"]', pt.dataApiKeydownHandler), B.on(document, "keydown.bs.dropdownboot.data-api", ".dropdownboot-menu", pt.dataApiKeydownHandler), B.on(document, "click.bs.dropdownboot.data-api", pt.clearMenus), B.on(document, "keyup.bs.dropdownboot.data-api", pt.clearMenus), B.on(document, "click.bs.dropdownboot.data-api", '[data-bs-toggle="dropdownboot"]', (function (t) {
    t.preventDefault(), pt.dropdownbootInterface(this)
  })), y(pt);
  class ft {
    constructor() {
  ...
  class Ft extends q {
    constructor(t, e) {
      super(t), this._scrollElement = "BODY" === this._element.tagName ? window : this._element, this._config = this._getConfig(e), this._selector = `${this._config.target} .nav-link, ${this._config.target} .list-group-item, ${this._config.target} .dropdownboot-item`, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, B.on(this._scrollElement, "scroll.bs.scrollspy", () => this._process()), this.refresh(), this._process()
    }
    static get Default() {
      return qt
    }
    ...
    _activate(t) {
      ...
      const e = this._selector.split(",").map(e => `${e}[data-bs-target="${t}"],${e}[href="${t}"]`),
        s = i.findOne(e.join(","));
      s.classList.contains("dropdownboot-item") ? (i.findOne(".dropdownboot-toggle", s.closest(".dropdownboot")).classList.add("active"), s.classList.add("active")) : (s.classList.add("active"), i.parents(s, ".nav, .list-group").forEach(t => {
  ...
  class Ut extends q {
    ...
    _transitionComplete(t, e, s) {
      if (e) {
        ...
        const t = i.findOne(":scope > .dropdownboot-menu .active", e.parentNode);
      ...
      let n = t.parentNode;
      if (n && "LI" === n.nodeName && (n = n.parentNode), n && n.classList.contains("dropdownboot-menu")) {
        const e = t.closest(".dropdownboot");
        e && i.find(".dropdownboot-toggle", e).forEach(t => t.classList.add("active")), t.setAttribute("aria-expanded", !0)
      }
      s && s()
    }
    static jQueryInterface(t) {
